      ...
      <Paper elevation={3}>
        <div className={classes.text}>
          ...
          <Typography className={classes.description} variant="h5">
            Have you ever received a present that you didn't like? This site is
            for you!
          </Typography>
          ...
          <Typography className={classes.description} variant="h6">
            It's perfect since it not only redistributes things and gadgets well
            (and so being environmentally friendly) but it redistributes
            happiness as well!
          </Typography>
        </div>
